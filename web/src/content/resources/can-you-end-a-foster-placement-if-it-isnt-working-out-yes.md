---
title: "Can You End a Foster Placement If It Isn’t Working Out? – Yes"
...
1.  Contact your case manager promptly and clearly explain the concerns.
2.  Allow the agency to attempt stabilization with added guidance or supports.
3.  Provide up to 45 days’ notice if the placement still cannot continue.
4.  Support transition planning while a new placement is identified.
5.  End the placement immediately if there is an urgent safety risk.
6.  Review the placement afterward to inform better future matching.
