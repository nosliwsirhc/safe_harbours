    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        html: renderEmail({
          tag: 'Newsletter',
          tagAccent: 'coral',
          title: name || 'New subscriber',
          subtitle: name ? 'Joined the newsletter' : 'A new email joined the newsletter',
          preheader: `${name || email} joined the newsletter`,
          email,
          rows: [{ label: 'Source', value: source }],
        }),
